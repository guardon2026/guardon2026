...
export const COMPANY_ONBOARDING = {
  ...
  FIELDS: {
    ...
    KAKAO_LABEL:          "카카오 오픈채팅 URL",
    KAKAO_PLACEHOLDER:    "https://open.kakao.com/o/...",
    KAKAO_HINT:           "경비 인력이 SOS 수락 전 문의할 수 있는 카카오 오픈채팅 링크입니다. 카카오톡 앱 → 채팅 탭 → 오픈채팅에서 링크를 복사하세요.",
  ...
  ERROR: {
    ...
    SECURITY_FILE_REQUIRED:   "경비업 허가증 파일을 업로드해 주세요.",
    ADDRESS_REQUIRED:   "주소를 입력해 주세요.",
    CITY_REQUIRED:      "시·도를 입력해 주세요.",
    DISTRICT_REQUIRED:  "구·군을 입력해 주세요.",
    PHONE_REQUIRED:     "대표 연락처를 입력해 주세요.",
    KAKAO_REQUIRED:     "카카오 오픈채팅 URL을 입력해 주세요.",
    KAKAO_FORMAT:       "올바른 카카오 오픈채팅 링크를 입력해 주세요. (https://open.kakao.com/으로 시작)",
...
export const SOS_FORM = {
  ...
  FIELDS: {
    ...
    HOURLY_RATE_LABEL:    "적용 시급",
    HOURLY_RATE_PLACEHOLDER: "숫자로만 기입",
    HOURLY_RATE_UNIT:     "원",
    DESCRIPTION_LABEL:    "업무 설명",
    DESCRIPTION_PLACEHOLDER: "예) 시설 경비 업무 일체, 행사 경비 업무 일체, 신변 보호 업무 일체 등",
  },
  ...
  ERROR: {
    ...
    HOURLY_RATE_INVALID:     "일급은 0원 이상이어야 합니다.",
...
export const CREDENTIAL_PAGE_LABELS = {
  ...
  SELECT_FILE:    "파일 선택 (JPG, PNG, PDF, 최대 10MB)",
  ISSUED_DATE:    "발급일 (선택)",
  UPLOAD_BTN:     "업로드",
  UPLOADING:      "업로드 중...",
