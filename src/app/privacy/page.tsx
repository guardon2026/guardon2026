...
export const metadata = {
  title: "개인정보처리방침 | GuardOn",
  description: "GuardOn 개인정보처리방침",
}

const SECTIONS = [
  {
    title: "제1조 (개인정보의 처리 목적)",
    content: `주식회사 지360(이하 "회사")은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경될 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행합니다.

① 회원 가입 및 관리
   회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정 이용 방지, 만 14세 미만 아동의 가입 제한

② 서비스 제공
   인력 매칭 서비스 제공, SOS 긴급 배치 서비스 운영, 위치 기반 서비스 제공, 자격증 인증 뱃지 발급, 이용 이력 관리

③ 고충 처리
   민원인 신원 확인, 민원사항 확인, 사실 조사를 위한 연락·통지, 처리 결과 통보

④ 마케팅 및 광고 활용 (별도 동의 시)
   이벤트 및 공지사항 안내, 맞춤형 서비스 추천`,
  },
  {
...
④ 서비스 이용 과정에서 자동 수집되는 정보
  ...
  },
  {
    ...
    content: `① 회사는 법령에 따른 개인정보 보유·이용 기간 또는 정보 주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유·이용 기간 내에서 개인정보를 처리·보유합니다.
...
② 각 개인정보 처리 및 보유 기간은 다음과 같습니다.
  ...
  },
  {
    ...
    content: `① 회사는 정보 주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보 주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② 매칭 서비스 특성상 다음의 경우 상대방에게 필요한 정보가 제공됩니다.
   - 업체 회원 → 인력 회원: 매칭 확정 시 업체명, 근무지 주소, 담당자 연락처
   - 인력 회원 → 업체 회원: 매칭 수락 시 이름, 자격증 정보, 연락처

③ 위 정보 제공은 서비스 이용 약관 동의 및 매칭 서비스 이용 동의 시 함께 동의한 것으로 처리됩니다.`,
  },
  {
    title: "제5조 (개인정보 처리 위탁)",
    content: `① 회사는 원활한 서비스 제공을 위해 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다.

   - 수탁업체: 카카오(주) | 위탁 업무: 카카오 소셜 로그인 인증
   - 수탁업체: 솔라피(SOLAPI) | 위탁 업무: SMS·알림톡 발송
   - 수탁업체: Amazon Web Services | 위탁 업무: 클라우드 인프라 운영 및 데이터 보관

② 회사는 위탁 계약 체결 시 개인정보 보호법 제26조에 따라 위탁 업무 수행 목적 외 개인정보 처리 금지, 기술적·관리적 보호조치, 재위탁 제한 등을 규정하며 이를 감독합니다.`,
  },
  {
    title: "제6조 (정보 주체의 권리·의무 및 행사 방법)",
    content: `① 정보 주체는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
   1. 개인정보 열람 요구
   2. 오류 등이 있을 경우 정정 요구
   3. 삭제 요구
   4. 처리 정지 요구
...
③ 만 14세 미만 아동의 개인정보 처리 시 법정대리인이 권리를 행사할 수 있습니다.`,
  },
  {
    title: "제7조 (처리하는 개인정보 항목의 안전성 확보 조치)",
...
④ 쿠키 저장을 거부할 경우 일부 서비스 이용에 어려움이 있을 수 있습니다.`,
  },
  {
    ...
    content: `① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 정보 주체의 개인정보 관련 불만 처리 및 피해 구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.

   - 성명: 개인정보 보호책임자
   - 소속: 주식회사 지360
   - 이메일: privacy@guardon.kr

② 정보 주체는 회사의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해 구제 등에 관한 사항을 개인정보 보호책임자에게 문의할 수 있습니다.`,
  },
  {
    title: "제10조 (개인정보 열람 청구)",
    content: `정보 주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 회사는 정보 주체의 개인정보 열람 청구가 신속하게 처리되도록 노력하겠습니다.

   - 부서명: 고객지원팀
   - 이메일: support@guardon.kr`,
  },
  {
    title: "제11조 (권익 침해 구제 방법)",
    content: `정보 주체는 아래의 기관에 개인정보 침해에 대한 피해 구제, 상담 등을 문의할 수 있습니다.
  ...
  {
    title: "부칙",
    content: `이 개인정보처리방침은 2026년 7월 1일부터 시행됩니다.`,
  },
]
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 mb-10">
          <p className="text-sm text-blue-800 leading-relaxed">
            주식회사 지360은 개인정보 보호법 등 관련 법령상의 개인정보 보호 규정을 준수하며,
            이용자의 개인정보 보호에 최선을 다하고 있습니다.
            본 방침을 통해 수집하는 개인정보의 항목, 이용 목적, 보관 기간 및 이용자의 권리를 안내드립니다.
          </p>
        </div>
        ...
        <div className="mt-12 bg-gray-50 rounded-xl p-6">
          <h3 className="text-sm font-semibold text-gray-900 mb-2">개인정보 관련 문의</h3>
          <p className="text-sm text-gray-500 leading-relaxed">
            개인정보처리방침에 관한 문의 사항은 아래로 연락해 주세요.<br />
            운영사: 주식회사 지360 | 개인정보 보호 이메일: privacy@guardon.kr
          </p>
        </div>
